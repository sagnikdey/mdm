...
function FieldLegend({
  ...
  return (
    <legend
      ...
      className={cn(
        "mb-2 font-medium data-[variant=label]:text-sm data-[variant=legend]:text-sm md:data-[variant=label]:text-sm/relaxed",
        className
      )}
      {...props}
    />
...
function FieldTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="field-label"
      className={cn(
        "flex w-fit items-center gap-2 text-sm font-medium group-data-[disabled=true]/field:opacity-50 md:text-sm/relaxed",
        className
      )}
      {...props}
    />
